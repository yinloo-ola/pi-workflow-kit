...
Feature phase: implementing (5/7)
...
| 6 | ⬜ | One folder per topic — a single-part topic and an umbrella share one shape | — | — |
| 7 | ⬜ | Both flows share one identity model (local umbrella detection, one slug, one disposal path) | — | — |
